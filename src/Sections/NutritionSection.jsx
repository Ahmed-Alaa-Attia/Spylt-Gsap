...
const NutritionSection = () => {
  ...
  useGSAP(() => {
    ...
    const pharagraphSplit = SplitText.create(".nutrition-section p", {
      type: "words , lines ",
    ...
    <section className="nutrition-section">
      ...
      <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0 ">
        <div className="relative inline-block md:translate-y-20">
          <div className="general-title relative flex flex-col items-center justify-center gap-28">
        ...
        <div className="flex md:justify-center items-center transla-y-5 ">
